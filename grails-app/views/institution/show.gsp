      ...
      float: right;
        ...
        <div class="body">
            ...
            <div class="dialog emulate-public">
              ...
              <!-- images -->
              <g:render plugin="collectory" template="/shared/images" model="[target: 'logoRef', image: instance.logoRef, title:'Logo', instance: instance]"/>
              <g:render plugin="collectory" template="/shared/images" model="[target: 'imageRef', image: instance.imageRef, title:'Representative image', instance: instance]"/>

              <!-- location -->
              <g:render plugin="collectory" template="/shared/location" model="[instance: instance]"/>

              <!-- Record providers and resources -->
              <g:render plugin="collectory" template="/shared/providers" model="[instance: instance]"/>

              <!-- Contacts -->
              <g:render plugin="collectory" template="/shared/contacts" model="[contacts: contacts, instance: instance]"/>

              <!-- Attributions -->
              <g:render plugin="collectory" template="/shared/attributions" model="[instance: instance]"/>

              <!-- external identifiers -->
              <g:render plugin="collectory" template="/shared/externalIdentifiers" model="[instance: instance]"/>

              <!-- GBIF integration -->
              <g:render plugin="collectory" template="/shared/gbif" model="[instance: instance]"/>

              <!-- change history -->
              <g:render plugin="collectory" template="/shared/changes" model="[changes: changes, instance: instance]"/>
