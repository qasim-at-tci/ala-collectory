<%@ page import="uk.org.nbn.collectory.ProviderGroupNbn; au.org.ala.collectory.Contact; au.org.ala.collectory.Institution" %>
<html>
    <head>
...
<!-- ALA partner -->        <g:ifAllGranted role="${ProviderGroupNbn.ROLE_ADMIN}">
                              <tr class="prop">
                                  <td valign="top" class="name">
...
<!-- address -->            <tr class="prop">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'logoRef', 'errors')}">
                                    <g:render plugin="collectory" template="/shared/attributableLogo" model="[command: providerGroupInstance, directory: 'institution', action: 'editInstitution']"/>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'imageRef', 'errors')}">
                                  <g:render plugin="collectory" template="/shared/attributableImage" model="[command: providerGroupInstance, directory: 'institution', action: 'editInstitution']"/>
                                </td>
                            </tr>
