...
<html>
        ...
        <div id="header" class="collectory">
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <g:render plugin="collectory" template="editButton"/>
            ...
            <div id="overviewTab" class="tab-pane active row">
               ...
               <div id="overview-sidebar" class="col-md-4">
                  ...
                  <div id="dataAccessWrapper" style="display:none;">
                      <g:render plugin="collectory" template="dataAccess" model="[instance:instance]"/>
                  </div>
                  ...
                  <!-- contacts -->
                  <g:render plugin="collectory" template="contacts" bean="${instance.getPublicContactsPrimaryFirst()}"/>
               ...
               <!-- external identifiers -->
                   <g:render plugin="collectory" template="externalIdentifiers" model="[instance:instance]"/>
    ...
    <g:render plugin="collectory" template="charts" model="[facet:'collection_uid', instance: instance]" />
    <g:render plugin="collectory" template="progress" model="[facet:'collection_uid', instance: instance]" />
    </body>
</html>
