...
%{--                    <i class="glyphicon glyphicon-info-sign"> </i> --}%
    ...
    <!-- contacts -->
        ...
        <g:render plugin="collectory" template="contacts" bean="${contacts}"/>
...
<g:render plugin="collectory" template="taxonTree" model="[facet:'data_resource_uid', instance: instance]" />
<g:render plugin="collectory" template="charts" model="[facet:'data_resource_uid', instance: instance]" />
</body>
</html>
