...
<g:render plugin="collectory" template="taxonTree" model="[facet:'data_provider_uid', instance: instance]" />
<g:render plugin="collectory" template="charts" model="[facet:'data_provider_uid', instance: instance]" />
